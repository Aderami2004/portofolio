...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container">
      <a class="navbar-brand fw-bold" href="#">Ade Rami Aminulloh</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-bold" href="/portofolio">Portofolio</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold" href="/profile/add">Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold" href="keluar">Keluar</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container mt-3 py-5">
    ...
    <tr>
        ...
        <td>
            <a href="admin/hapus{id}{{ $item->id }}"><button class="btn btn-danger">Hapus</button></a>
            <a href="admin/edit{id}{{ $item->id }}"><button class="btn btn-primary">Edit</button></a>
        </td>
    </tr>
    @endforeach
    </table>
